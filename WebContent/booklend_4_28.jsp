...
<table border="1" width="599">
		...
		<s:if test="#request.readerId==null">
			<td colspan="2">
				Book Info&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;ISBN<s:textfield name="lend.ISBN" size="15" disabled="true"></s:textfield>
				&nbsp;&nbsp;&nbsp;&nbsp;Book ID<s:textfield name="lend.bookId" size="15" disabled="true"></s:textfield>
				<s:submit value="lend" disabled="true"/>
			</td>
		</s:if>
		<s:else>
			<td colspan="2">
				Book Info&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;ISBN<s:textfield name="lend.ISBN" size="15"></s:textfield>
				&nbsp;&nbsp;&nbsp;&nbsp;Book ID<s:textfield name="lend.bookId" size="15"></s:textfield>
		...
		<tr>
			<td height="360" valign="top"><jsp:include page="lendbookinfo_4_28.jsp"/></td>
		</tr>
		<tr>
			<td align="center">
